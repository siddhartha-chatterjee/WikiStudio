...
export default function ArticleBuilder() {
  ...
  const availableSections = ["Early Life", "Alma Matter", "Works", "Recognitions", "Social Impact", "Legacy", "Controversies", "Personal Life", "Further Reading", "External Links"]
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <h1
              className="text-2xl sm:text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white via-gray-200 to-gray-400 leading-none tracking-tighter mb-4"
              style={{
            ...
            >
              Build your biographical article with our structured editor
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-2xl overflow-hidden">
            ...
            <div className="bg-gray-50 border-b border-gray-200 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-medium">Wikipedia Article Builder : <b>Persona</b></span>
              </div>
            </div>
                          ...
                          {personName.trim() ? (
                            ...
                            <div className="text-center py-12">
                              <p className="black text-lg">
                                Please enter a person's name and add content to preview the article.
                              </p>
                            </div>
                          )}
                        </div>
