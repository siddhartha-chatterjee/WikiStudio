...
export default function ArticleBuilder() {
  ...
  const availableSections = ["Etymology", "Occurrence", "Causes", "Impact", "Historical Views", "Cultural Significance", "Scientific Studies", "Related Phenomena", "Further Reading", "External Links"]
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            >
              Write about some phenomena or events with our structured editor
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-2xl overflow-hidden">
            ...
            <div className="bg-gray-50 border-b border-gray-200 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-medium">Wikipedia Article Builder : <b>Phenomena</b></span>
              </div>
            </div>
